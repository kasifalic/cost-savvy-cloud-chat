      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-20">
          ...
          <nav className="hidden md:flex">
            <div className="flex bg-white/90 backdrop-blur-xl rounded-2xl p-1 border border-white/30 shadow-lg">
              {navItems.map((item) => {
                ...
                return (
                  <button
                    ...
                    className={`relative flex items-center space-x-2 px-6 py-3 rounded-xl text-sm font-medium transition-all duration-300 ${
                      activeTab === item.id
                        ? 'text-white bg-gradient-to-r from-teal-500 to-orange-600 shadow-lg border border-white/40'
                  ...
                  >
                    ...
                    <Icon className={`h-4 w-4 relative z-10 ${activeTab === item.id ? 'text-white' : 'text-black'}`} />
